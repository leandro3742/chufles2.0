  ...
  return (
    <div>
        ...
        <div className="row justify-content-center">
            <div className="col-11 col-lg-5 d-flex flex-column align-items-center mt-4 ml-1 mr-1">
            ...
            <div className="col-11 col-lg-6 d-flex flex-column align-items-center mt-4 ml-1 mr-1">
            ...
            <div className="col-11 col-lg-6 d-flex flex-column align-items-center mt-4 ml-2 mr-2">
                <h5 className="text-danger" >Nuestra meta</h5> 
